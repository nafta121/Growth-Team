...
- Workspace ID: `0e1cd0dd-a62d-4f6b-8a78-5f0a2312e910`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/0e1cd0dd-a62d-4f6b-8a78-5f0a2312e910.
...
2. `npx ngodingpakeai connect --workspace 0e1cd0dd-a62d-4f6b-8a78-5f0a2312e910 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/0e1cd0dd-a62d-4f6b-8a78-5f0a2312e910. Only pass on links the CLI actually printed — never assemble one from an id yourself.
